...
from camel.configs import ChatGPTConfig, QwenConfig, VLLMConfig, OpenRouterConfig, GeminiConfig, AnthropicConfig, BedrockConfig
...
def get_agent_config(model_type):
    ...
    if model_type == 'qwen':
        ...
        agent_config = {
            ...
            "model_config": AnthropicConfig().as_dict(),
    ...
    elif model_type == 'bedrock-sonnet':
        agent_config = {
            "model_type": ModelType.AWS_CLAUDE_SONNET_4,
            "model_config": BedrockConfig().as_dict(),
            "model_platform": ModelPlatformType.AWS_BEDROCK,
            'max_images': 99
        }
    elif model_type == 'bedrock-opus':
        agent_config = {
            "model_type": ModelType.AWS_CLAUDE_OPUS_4,
            "model_config": BedrockConfig().as_dict(),
            "model_platform": ModelPlatformType.AWS_BEDROCK,
            'max_images': 99
        }
    elif model_type == 'bedrock-haiku':
        agent_config = {
